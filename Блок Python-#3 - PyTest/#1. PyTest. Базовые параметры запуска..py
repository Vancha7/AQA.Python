#pytest практика\test_my.py -s          = в результате видим последний принт.
#pytest практика\test_my.py -s -v       В результате мы увидим то, какой тест запускаем, какому классу
#                                       он относится и статус выполнения теста.
